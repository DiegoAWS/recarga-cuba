...
const PlansContainer = tw.div`mt-16 min-h-screen flex flex-col items-center lg:flex-row lg:items-stretch lg:justify-between text-gray-900 font-medium`;
const Plan = styled.div`
  ${tw`w-full h-full bg-blue-700 max-w-sm bg-white rounded-lg shadow-sm py-10 px-6 sm:px-10 lg:px-6 lg:py-10 xl:p-10 mx-3 flex flex-col justify-between mt-16 first:mt-0 lg:mt-0 shadow-raised`}
`;
...
export default ({
  ...
  description = "Recargue a Cuba con los mejores precios disponibles del Internet",
  plans = null,
  ...
  const defaultPlans = [
    {
      ...
      price: ["$19", ".90/recarga"],
      oldPrice: "$19.99",
      description: "Perfecto para una vez y una sola recarga",
      features: ["Recarga 1 teléfono"],
      url: "https://google.com",
      featured: "Servicio Básico"
    },
    {
      name: "Estandar",
      price: ["$19", ".85/recarga"],
      oldPrice: "$19.99",
      description: "Ideal para Recargar a Amigos y conocidos",
      features: [
        "5 recargas a Cuba"
      ],
      url: "https://google.com",
    ...
    },
    {
      ...
      price: ["$19", ".75/month"],
      oldPrice: "$19.99",
      description: "Para Grandes Clientes, Grandes Soluciones",
      features: [
        "20+ Recargas"
      ],
      url: "https://google.com",
      featured: "Más Económico"
    }
  ];
  ...
  return (
    <Container>
      <ContentWithPaddingXl>
        ...
        <PlansContainer style={{marginBottom:'100vh'}}>
