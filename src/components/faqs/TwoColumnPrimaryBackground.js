...
export default ({
  ...
  faqs = [
    ...
    {
      question: "Es necesario Registrarse para enviar recargas?",
      answer:
        "Para nada. Para efectuar una recarga individual no es necesario registrarse. Si decide registrarse recibirá un descuento por cada recarga, recibirá un enlace de referidos y ganará acceso a Premios, Ofertas y estatus VIP"
    },
    {
      question: "Las transferencias son seguras?",
      answer:
        "Actualmente operamos bajo licencias electrónicas que garantizan la transparencia y seguridad de su envío. Contamos con varios años de experiencia con un servicio siempre de excelencia"
    },
    {
      question: "Qué debo hacer si mi recarga no llega ?",
      answer:
        "En ciertas ocasiones las redes de Telecomunicaciones de Cuba se encuentran saturadas y su recarga puede demorar en ser entregada"
    },
    {
      question: "Si recargo varias veces obtengo rebajas ? ",
      answer:
        "Si!! Con registrarse Ud accede a la sección VIP que le permite acumular puntos por cada recarga, y entre más punto Ud acumule, más descuentos recibirá..."
    },
    {
      question: "Cómo funciona el sistema de referidos ?",
      answer:
        "Si Ud realiza una vez registrado recarga con nosotros, recibe automáticamente un enlace de referido. Este enlace de nuestra página Ud puede distribuirlo entre amigos y familiares. Cada vez que un referido suyo realice una recarga Ud recibirá puntos de Descuentos y Premios",
    }
  ]
}) => {
  const faqCol1 = [];
