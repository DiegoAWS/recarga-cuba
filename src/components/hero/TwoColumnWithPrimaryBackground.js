...
import logoImageSrc from "images/shield-icon.svg";
import moneyTransferImageSrc from "images/undraw_transfer_money_rywa.svg";
...
export default ({
  heading = "Recargas a Cuba",
  description = "Las Recargas más Económicas, rápidas y seguras",
  primaryButtonText = "Recarga Ahora mismo",
  primaryButtonUrl = "#",
  imageSrc = moneyTransferImageSrc,
}) => {
  const logoLink = (
    <LogoLink href="/">
  ...
  const navLinks = [
    <NavLinks key={1}>
      ...
      <NavLink href="#">Membresía</NavLink>
