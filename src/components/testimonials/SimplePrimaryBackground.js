...
export default ({
  subheading = "",
  heading = "Testimonios",
  description = "Su opinión es lo más importante, esperamos su reseña",
  testimonials = [
    {
      customerName: "Alfredo Rodríguez",
      customerProfile: "Fort Lauderdale, Florida",
      imageSrc:
      ...
      quote:
        "Por varios meses hemos recargado con esta página y siempre entregan al momento, gente seria y cumplidora."
    },
    {
      customerName: "Amanda Lópex",
      customerProfile: "Dallas, Texas",
      imageSrc:
      ...
      quote:
        "Mi abuelita recibe cada mes una recarga gracias a Ustedes!!!"
    },
    {
      customerName: "Rolando Benítez Ortega",
      customerProfile: "Miami, Florida",
      imageSrc:
      ...
      quote:
        "Cada mes movemos más de 250 recargas y su servicio es de lujo, preciso exacto y con mucha profesionalidad."
    }
  ]
}) => {
